...
#+begin_src emacs-lisp
    ...
    (add-hook 'compilation-filter-hook 'ansi-color-compilation-filter) ;; For ANSI colors
...
*** Colors
#+begin_src emacs-lisp
  (set-face-attribute 'org-meta-line nil :height 0.8 :slant 'normal :foreground "#555555")
  (custom-set-faces '(org-block ((t (:background "#181818" :foreground "#e4e4ef")))))
#+end_src
* sudo-edit
#+begin_src emacs-lisp
