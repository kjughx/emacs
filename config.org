...
#+begin_src emacs-lisp
  ...
  (add-hook 'straight-use-package-mode-hook (lambda () (if (active-mode-p 'straight-use-package-mode) (straight-freeze-versions))))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (add-hook 'dts-mode-hook (lambda () (setq indent-tabs-mode t) (setq tab-width 4)))
#+end_src
* Comment
#+begin_src emacs-lisp
